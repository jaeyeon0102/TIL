class MinHeap:
    ...
    def heapify(self, array):
        ...
        self.length = len(array)    # 힙의 길이 저장
        # 중간 부터 시작해서 자식이 있는 노드들만 정리
        # 끝에서 두 번째 줄부터 위로 올라가며 힙 구조 정리
